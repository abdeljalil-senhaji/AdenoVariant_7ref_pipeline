...
include: rulePath+"/addorreplacereadgroups_rule"
...
include: rulePath+"/createsequencedictionnary1_rule"
include: rulePath+"/realignertargetcreator_rule"
include: rulePath+"/indelrealigner_rule"
include: rulePath+"/samtools_mpileup_rule"
include: rulePath+"/varscan_rule"
include: rulePath+"/bgzip_rule"
include: rulePath+"/tabix_rule"
include: rulePath+"/bedtools_genomecov_rule"
include: rulePath+"/extractline_rule"
include: rulePath+"/bwa_index_rule"
include: rulePath+"/samtools_faidx_rule"
...
sample_ids = []
sampleName=glob.glob("/scratch/recherche/asenhaji/AdenoVariant_7ref_pipeline/data/*.fastq.gz")
...
#trimmomatic = expand((output_path+"/{sample_id}/{sample_id}_R _paired.fq.gz", output_path+"/{sample_id}/{sample_id}_R2_paired.fq.gz", output_path+"/{sample_id}/{sample_id}_R _unpaired_trim.fq.gz", output_path+"/{sample_id}/{sample_id}_R2_unpaired_trim.fq.gz"), sample_id = sample_ids),
